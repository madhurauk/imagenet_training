...
python main.py -a resnet18 --dist-url 'tcp://127.0.0.1:8888' --dist-backend 'nccl' --multiprocessing-distributed --world-size 1 --rank 0 --epochs 1 /coc/scratch/mummettuguli3/data/imagenet